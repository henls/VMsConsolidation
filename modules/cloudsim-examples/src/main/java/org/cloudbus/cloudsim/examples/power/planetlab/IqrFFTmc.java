...
public class IqrFFTmc {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = IqrFFTmc.class.getClassLoader().getResource("workload/planetlab").getPath();
		String outputFolder = "output";
		String workload = "20110303"; // PlanetLab workload
		String vmAllocationPolicy = "iqr"; // Inter Quartile Range (IQR) VM allocation policy
		String vmSelectionPolicy = "fftmc"; // FFT Maximum Correlation (FFT MC) VM selection policy
