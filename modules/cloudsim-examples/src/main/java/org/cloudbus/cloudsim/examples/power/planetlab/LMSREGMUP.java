...
public class LMSREGMUP {
	...
	public static void main(String[] args) throws IOException {
		...
		String vmAllocationPolicy = "LMSREGMUP"; // Inter Quartile Range (IQR) VM allocation policy
		String vmSelectionPolicy = "MuP"; // Maximum Correlation (MC) VM selection policy
