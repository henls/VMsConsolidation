...
public class ACSVMC {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = MadMmt.class.getClassLoader().getResource("workload/google").getPath();
		String outputFolder = "output";
		String workload = "20110501-cap"; // PlanetLab workload
		String vmAllocationPolicy = "ACSVMC"; // Median Absolute Deviation (MAD) VM allocation policy
