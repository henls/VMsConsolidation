...
public class GRANITE {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = GRANITE.class.getClassLoader().getResource("workload/planetlab").getPath();
		String outputFolder = "output";
		String workload = "20110303"; // PlanetLab workload
		String vmAllocationPolicy = "GRANITE"; // Median Absolute Deviation (MAD) VM allocation policy
