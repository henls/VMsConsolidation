 ...
 */
public class PowerVmSelectionPolicyMaximumCorrelationCoefficient extends PowerVmSelectionPolicy {
	 ...
	 */
	public PowerVmSelectionPolicyMaximumCorrelationCoefficient(final PowerVmSelectionPolicy fallbackPolicy) {
		super();
	...
	public Vm getVmToMigrate(final PowerHost host) {
		...
		System.out.println("migratableVms: " + maxIndex);
	...
	protected double[][] getUtilizationMatrix(final List<PowerVm> vmList) {
		...
		System.out.println("minUtilizationSize: " + m);
